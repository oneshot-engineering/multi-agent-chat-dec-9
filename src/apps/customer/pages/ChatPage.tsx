  ...
  return (
    <div className="flex h-screen bg-white relative">
      ...
      >
        ...
        >
          {isChatExpanded ? (
            <ChevronLeft className="w-5 h-5" style={{ color: theme.colors.text.secondary }} />
          ) : (
            <ChevronRight className="w-5 h-5" style={{ color: theme.colors.text.secondary }} />
          )}
        </button>

        <div className={`h-full flex flex-col ${isChatExpanded ? '' : 'overflow-hidden'}`}>
          {isChatExpanded ? (
            <>
              <ChatHeader
            ...
            <div className="h-full flex flex-col items-center py-8">
              ...
              />
              <div className="writing-mode-vertical text-sm" style={{ color: theme.colors.text.secondary }}>
                Chat
              </div>
            </div>
          )}
