...
export const mockConversation = [
  ...
  },
  {
    ...
    data: {
      reasoning:
        "Here’s a detailed week-by-week execution plan for your outbound strategy. This includes preparation, tools, and workflow recommendations.",
      output: {
        type: "proposal",
        data: mockProposal,
      },
      question:
        "Does this strategy align with your goals? Let me know if you'd like to adjust anything.",
    },
  },
];
